...
function draw() {
  ...
  histEvent(600, 200, "Dec. 1961", true, "Harold and Luella call their young family together and form a corporation. They use horses to carry some of the supplies.");
...
function histEvent(x, y, title, top, detail) {
  if (top === true) {
    line(x, y, x - 15, y + 50);
  } else {
    line(x, y, x - 15, y - 50);
